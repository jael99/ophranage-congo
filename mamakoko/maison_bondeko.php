					...
					<div class="row">
						<div class="col-xs-12">
							...
							<section class="process-section anim-section text-center">
								...
								<?php
									$cj = mysqli_query($bdd,"select * from bondeko")or die(mysqli_error($bdd));
									?>
									<table class="table">
										<thead>
											<tr>
										...
										<?php while($data=mysqli_fetch_array($cj)){?>
											...
											<tr>
												<th scope="row"><?php echo $data['id_bondeko'];?></th>
												<td><?php echo $data['nom_bondeko'];?></td>
												<td><?php echo $data['age_bondeko'];?></td>
												<td><?php echo $data['sexe_bondeko'];?></td>
												<td><?php echo $data['classe_bondeko'];?></td>
												<td><a href="form_bondeko.php?nom=<?php echo $data['nom_bondeko']; ?>" class="btn btn-default btn-lg join-today">Parrainer</a></td>
											</tr>
											<?php } ?>
										</tbody>
									</table>
