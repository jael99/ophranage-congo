...
<html lang="en">
	<head>
		...
		<title>Fondation Mama Kokos</title>
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<section class="process-section anim-section text-center">
								...
								<?php
									$cj = mysqli_query($bdd,"select * from casa")or die(mysqli_error($bdd));
									?>
									<table class="table">
										<thead>
											<tr>
												...
												<th scope="col" class="text-center">Scolarité</th>
										...
										<?php while($data=mysqli_fetch_array($cj)){?>
											...
											<tr>
												<th scope="row"><?php echo $data['id_casa'];?></th>
												<td><?php echo $data['nom_casa'];?></td>
												<td><?php echo $data['age_casa'];?></td>
												<td><?php echo $data['sexe_casa'];?></td>
												<td><?php echo $data['scolarite_casa'];?></td>
												<td><a href="form_casa.php?nom=<?php echo $data['nom_casa']; ?>" class="btn btn-default btn-lg join-today">Parrainer</a></td>
											</tr>
											<?php } ?>
										</tbody>
									</table>
