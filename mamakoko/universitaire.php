					...
					<div class="row">
						<div class="col-xs-12">
							...
							<section class="process-section anim-section text-center">
								...
								<?php
									$cj = mysqli_query($bdd,"select * from univ")or die(mysqli_error($bdd));
									?>
									<table class="table">
										<thead>
											<tr>
												...
												<th scope="col" class="text-center">Insitution</th>
										...
										<?php while($data=mysqli_fetch_array($cj)){?>
											...
											<tr>
												<th scope="row"><?php echo $data['id_univ'];?></th>
												<td><?php echo $data['nom_univ'];?></td>
												<td><?php echo $data['sexe_univ'];?></td>
												<td><?php echo $data['fac_univ'];?></td>
												<td><?php echo $data['classe_univ'];?></td>
												<td><?php echo $data['ecole_univ'];?></td>
												<td><a href="form_univ.php?nom=<?php echo $data['nom_univ']; ?>" class="btn btn-default btn-lg join-today">Parrainer</a></td>
											</tr>
											<?php } ?>
										</tbody>
									</table>
