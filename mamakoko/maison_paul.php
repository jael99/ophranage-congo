					...
					<div class="row">
						<div class="col-xs-12">
							...
							<section class="process-section anim-section text-center">
								...
								<?php
									$cj = mysqli_query($bdd,"select * from sr_paul")or die(mysqli_error($bdd));
									?>
									<table class="table">
										<thead>
											<tr>
										...
										<?php while($data=mysqli_fetch_array($cj)){?>
											...
											<tr>
												<th scope="row"><?php echo $data['id_paul'];?></th>
												<td><?php echo $data['nom_paul'];?></td>
												<td><?php echo $data['age_paul'];?></td>
												<td><?php echo $data['sexe_paul'];?></td>
												<td><?php echo $data['classe_paul'];?></td>
												<td><a href="form_paul.php?nom=<?php echo $data['nom_paul']; ?>" class="btn btn-default btn-lg join-today">Parrainer</a></td>
											</tr>
											<?php } ?>
										</tbody>
									</table>
