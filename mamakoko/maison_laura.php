					...
					<div class="row">
						<div class="col-xs-12">
							...
							<section class="process-section anim-section text-center">
								...
								<?php
									$cj = mysqli_query($bdd,"select * from laura")or die(mysqli_error($bdd));
									?>
									<table class="table">
										<thead>
											<tr>
										...
										<?php while($data=mysqli_fetch_array($cj)){?>
											...
											<tr>
												<th scope="row"><?php echo $data['id_laura'];?></th>
												<td><?php echo $data['nom_laura'];?></td>
												<td><?php echo $data['age_laura'];?></td>
												<td><?php echo $data['sexe_laura'];?></td>
												<td><?php echo $data['classe_laura'];?></td>
												<td><a href="form_laura.php?nom=<?php echo $data['nom_laura']; ?>" class="btn btn-default btn-lg join-today">Parrainer</a></td>
											</tr>
											<?php } ?>
										</tbody>
									</table>
