					...
					<div class="row">
						<div class="col-xs-12">
							...
							<section class="process-section anim-section text-center">
								...
								<?php
									$cj = mysqli_query($bdd,"select * from foyer")or die(mysqli_error($bdd));
									?>
									<table class="table">
										<thead>
											<tr>
										...
										<?php while($data=mysqli_fetch_array($cj)){?>
											...
											<tr>
												<th scope="row"><?php echo $data['id_foyer'];?></th>
												<td><?php echo $data['nom_foyer'];?></td>
												<td><?php echo $data['age_foyer'];?></td>
												<td><?php echo $data['sexe_foyer'];?></td>
												<td><?php echo $data['classe_foyer'];?></td>
												<td><a href="form_foyer.php?nom=<?php echo $data['nom_foyer']; ?>" class="btn btn-default btn-lg join-today">Parrainer</a></td>
											</tr>
											<?php } ?>
										</tbody>
									</table>
